...
export default {
  ...
  'MenuHeader.step1': 'Как настроить',
  'MenuHeader.step2': 'Частые вопросы',
  'MenuHeader.step3': 'Новости ',
  ...
  "TopDevicesSub.Add": 'Добавить',

  //Main menu
  "MainMenu.Item1": 'Настройки просмотра',
  "MainMenu.Item2": 'Управление DNS',
  "MainMenu.Item3": 'Лог работы',
  "MainMenu.Item4": 'Мои рефералы',
  "MainMenu.Item5": 'Поддержка',
  "MainMenu.Player": 'Онлайн плеер',


  //Steps Block
  "Steps.Item1": 'Устройство',
  "Steps.Item2": 'Подписка',
  "Steps.Item3": 'Настройка',
  "Steps.Item4": 'Каналы',
  "Steps.Item5": 'Плейлист',

  "Intro.Title1": 'Здесь все просто ',
  "Intro.Title2": ' и удобно!',
  "Intro.Step1Icon": '1 шаг',
  "Intro.Step2Icon": '2 шаг',
  "Intro.Step3Icon": '3 шаг',
  "Intro.Step4Icon": '4 шаг',
  "Intro.Step5Icon": '5 шаг',

  "Intro.Step1Txt": 'Создаем устройства, на которых будем смотреть ',
  "Intro.Step2Txt": 'Доступ на 24 часа или Покупка подписки ',
  "Intro.Step3Txt": 'Настраиваем IPTV под свое устройство',
  "Intro.Step4Txt": 'Выбираем каналы для просмотра и создаем плейлисты',
  "Intro.Step5Txt": 'Скачиваем плейлист или копируем ссылку',

  "Intro.Go": 'Поехали!',

  //my devices block
  'MyDevicesBlock.Title': 'Мои устройства для настройки ',
  'MyDevicesBlock.Txt': 'Выберите из списка или создайте новое устройство',
  ...
  'PromoAside.Txt2': 'Смотрите IPTV 24 часа - бесплатно!',
  'PromoAside.Txt3': 'После теста есть подписка',
  'PromoAside.Href': 'Начать просмотр',

  //AsideDevices
  'AsideDevices.Title': 'Устройство',

  //Aside playlists
  'AsidePlaylist.Title': ' Мои плейлисты',
  'AsidePlaylist.Add': 'Добавить',

  'AsideServers.Title': 'Мои серверы',
  ...
  'Tooltip.TableView': 'Показать в таблице',

  //modals

  'Modal.Remove.Btn': 'Удалить',
  'Modal.Remove.Txt': ' Хотите удалить устройство?',
  ...
  'FormUser.Password': 'Пароль',
  'FormUser.Email': 'E-mail',

  //carousel

  'SliderNotifications.Txt1' : 'Уважаемые абоненты прием Webmoney отключен (заблокировали кошелек) и больше производится не будет!',
  'SliderNotifications.Title1' : 'Изменения в бесплатном тесте',
  'SliderNotifications.Note' : 'срочно!',
  'SliderNotifications.More' : 'Читать подробно',
  'SliderNotifications.Date' : '3 мая 2020 г.',
  ...
  'ResendEmail.Description': 'This email account is not verified. You need to verify your email address before start using the portal.' +
  ...
  'ResendEmail.Notification.SuccessMessage': 'Verification email sent successfully.',
  ...
  'ForgotPassword.Description': 'Enter you email address and we will send you an email to reset your password',
  ...
  'ForgotPassword.Notification.ErrorMessage':
    'There is something wrong with the data you have entered, please try again later, or contact your church support',
  'Auth.form.error.email.format': 'Not valid email address, please write it the correct format',
  'Auth.form.error.user.not-exist': 'No accounts found for this email address, please make sure to write it correctly',
  ...
  'ResetPassword.Notification.SuccessMessage': 'Yor password has been reset successfully',
